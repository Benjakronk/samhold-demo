...
window.STARTING_SETTLEMENT_RADIUS = CONSTANTS.STARTING_SETTLEMENT_RADIUS;
window.NEW_SETTLEMENT_RADIUS = CONSTANTS.NEW_SETTLEMENT_RADIUS;
window.TERRITORY_GOVERNANCE_THRESHOLD = CONSTANTS.TERRITORY_GOVERNANCE_THRESHOLD;
window.TERRITORY_GOVERNANCE_STRAIN_LEGITIMACY = CONSTANTS.TERRITORY_GOVERNANCE_STRAIN_LEGITIMACY;
window.TERRITORY_GOVERNANCE_STRAIN_BONDS = CONSTANTS.TERRITORY_GOVERNANCE_STRAIN_BONDS;
window.TERRITORY_STRAIN_OFFSET_PER_WORKER = CONSTANTS.TERRITORY_STRAIN_OFFSET_PER_WORKER;
window.CULTURAL_GROWTH_BASE_COST = CONSTANTS.CULTURAL_GROWTH_BASE_COST;
window.CULTURAL_GROWTH_STEP = CONSTANTS.CULTURAL_GROWTH_STEP;
window.CULTURAL_GROWTH_DECAY = CONSTANTS.CULTURAL_GROWTH_DECAY;
...
window.WINTER_FOOD_PER_POP = 0.5;
...
window.RETIREMENT_AGE_MIN = CONSTANTS.RETIREMENT_AGE_MIN;
window.RETIREMENT_AGE_MAX = CONSTANTS.RETIREMENT_AGE_MAX;
window.RETIREMENT_AGE = CONSTANTS.RETIREMENT_AGE;
window.WORKING_ELDER_DEATH_MULTIPLIER = CONSTANTS.WORKING_ELDER_DEATH_MULTIPLIER;
window.WORKING_ELDER_RESENTMENT = CONSTANTS.WORKING_ELDER_RESENTMENT;
...
window.adjustRetirementAge = Governance.adjustRetirementAge;
window.getPolicyLabel = Governance.getPolicyLabel;
window.getWorkingAgeLabel = Governance.getWorkingAgeLabel;
window.getRetirementAgeLabel = Governance.getRetirementAgeLabel;
...
window.getCohesionBreakdown = Cohesion.getCohesionBreakdown;
...
window.getWorkingElderCount = TurnProcessing.getWorkingElderCount;
window.getRetiredElderCount = TurnProcessing.getRetiredElderCount;
window.getAssignableIdle = TurnProcessing.getAssignableIdle;
...
// Phase 15+ dev controls
window.devSetPolicy = DevPanel.devSetPolicy;
window.devSetCohesion = DevPanel.devSetCohesion;
window.devAdjustCohesion = DevPanel.devAdjustCohesion;
window.devSetAllCohesion = DevPanel.devSetAllCohesion;
window.devAdvanceTurns = DevPanel.devAdvanceTurns;
window.devDamageSettlement = DevPanel.devDamageSettlement;
window.devHealSettlement = DevPanel.devHealSettlement;
window.devSetCulturalStrength = DevPanel.devSetCulturalStrength;
window.devSetExpansionPoints = DevPanel.devSetExpansionPoints;
window.devAddExpansionPoints = DevPanel.devAddExpansionPoints;
window.devClearClaimedHexes = DevPanel.devClearClaimedHexes;
window.devRunCulturalGrowth = DevPanel.devRunCulturalGrowth;
window.devRunExpansionPoints = DevPanel.devRunExpansionPoints;
window.devCreateUnitFree = DevPanel.devCreateUnitFree;
window.devEstablishRandomTradition = DevPanel.devEstablishRandomTradition;
window.devAddStoryteller = DevPanel.devAddStoryteller;
window.devRemoveStoryteller = DevPanel.devRemoveStoryteller;
window.devForceStory = DevPanel.devForceStory;
window.devToggleSystem = DevPanel.devToggleSystem;
...
window.showPillarBreakdown = OverlayRenderers.showPillarBreakdown;
window.renderPillarBreakdownInline = OverlayRenderers.renderPillarBreakdownInline;
window.showResourceBreakdown = OverlayRenderers.showResourceBreakdown;
window.togglePyramidImmigrants = OverlayRenderers.togglePyramidImmigrants;
window.showResistanceNegotiationDialog = OverlayRenderers.showResistanceNegotiationDialog;
window.confirmCommitPolicy = OverlayRenderers.confirmCommitPolicy;
window.confirmAbandonPolicy = OverlayRenderers.confirmAbandonPolicy;
window.confirmForcePolicy = OverlayRenderers.confirmForcePolicy;
...
window.showSettlementNamingDialog = Territory.showSettlementNamingDialog;
window.getSettlementForHex = Territory.getSettlementForHex;
window.getSettlementIndexForHex = Territory.getSettlementIndexForHex;
window.isClaimedHex = Territory.isClaimedHex;
window.isCoreHex = Territory.isCoreHex;
window.isAdjacentToTerritoryHex = Territory.isAdjacentToTerritoryHex;
window.processSettlementHealth = Territory.processSettlementHealth;
window.processSettlementCulturalGrowth = Territory.processSettlementCulturalGrowth;
window.getTerritoryGovernanceStrain = Territory.getTerritoryGovernanceStrain;
window.processExpansionPoints = Territory.processExpansionPoints;
window.getAdminHallWorkerCount = Territory.getAdminHallWorkerCount;
window.getHexPurchaseCost = Territory.getHexPurchaseCost;
window.canPurchaseHex = Territory.canPurchaseHex;
window.purchaseHex = Territory.purchaseHex;
window.showPurchaseHexConfirmation = Territory.showPurchaseHexConfirmation;
window.damageSettlement = Territory.damageSettlement;
window.destroySettlement = Territory.destroySettlement;
window.forfeitHex = Territory.forfeitHex;
window.showForfeitConfirmation = Territory.showForfeitConfirmation;
...
window.getProjectedTraditionCosts = Culture.getProjectedTraditionCosts;
...
window.projectResistanceDelta = Resistance.projectResistanceDelta;
...
window.getClassProductionMultiplier = ClassSystem.getClassProductionMultiplier;
